...
# to generate UMAP plots across Figures 2 to 4 and Extended Figures 2 to 3
svg("C:/Users/nicho/Desktop/NUS_PhD/220204 scRNAseq_slices/230410/UMAP by cell type all.svg",width=6,height=6)
ggplot(cbind(Embeddings(all_slices_filt,"umap"),all_slices_filt[["final_cell_type2"]]), aes(UMAP_1,UMAP_2,color=final_cell_type2)) +
  geom_point(size=0.4) + scale_color_manual(values=c("Cancer cell"="#FF0000","Fibroblast"="#FF8000","Endothelial"="#F74ED6","Pericyte"="#16B251",
                                                     "Myocyte"="#0066FF","T cell"="#00FE7F","B cell"="#8C56F8","Plasma cell"="#A6752C","Dendritic cell"="#E19FD3",
                                                     "Macrophage"="#ffd500","Neutrophil"="#50D2FA","Mast cell"="#023047","Monocyte"="#9A4452","Other"="#a6a2a2")) +
  theme(panel.background = element_rect(fill=NA,color="black"), axis.line = element_blank(),
        axis.text = element_blank(), axis.ticks = element_blank(), axis.title = element_blank(),
        legend.position = "none") + xlim(-16.5,15.5) + ylim(-17,15)
dev.off()
svg("C:/Users/nicho/Desktop/NUS_PhD/220204 scRNAseq_slices/230410/UMAP by cell type Original.svg",width=6,height=6)
ggplot(cbind(Embeddings(subset(all_slices,Condition=="Original"),"umap"),subset(all_slices,Condition=="Original")[["final_cell_type2"]]), aes(UMAP_1,UMAP_2,color=final_cell_type2)) +
  geom_point(size=0.4) + scale_color_manual(values=c("Cancer cell"="#FF0000","Fibroblast"="#FF8000","Endothelial"="#F74ED6","Pericyte"="#16B251",
                                                     "Myocyte"="#0066FF","T cell"="#00FE7F","B cell"="#8C56F8","Plasma cell"="#A6752C","Dendritic cell"="#E19FD3",
                                                     "Macrophage"="#ffd500","Neutrophil"="#50D2FA","Mast cell"="#023047","Monocyte"="#9A4452","Other"="#a6a2a2")) +
  theme(panel.background = element_rect(fill=NA,color="black"), axis.line = element_blank(),
        ...
        legend.position = "none") + xlim(-16.5,15.5) + ylim(-17,15)
dev.off()
svg("C:/Users/nicho/Desktop/NUS_PhD/220204 scRNAseq_slices/230410/UMAP Cancer subtype HN396.svg",width=6,height=6)
ggplot(cbind(Embeddings(subset(all_slices_sub$`Cancer cell`,PatientID=="HN396"),"umap"),
             subset(all_slices_sub$`Cancer cell`,PatientID=="HN396")[["sub_cell_type"]]), aes(UMAP_1,UMAP_2,color=sub_cell_type)) +
  geom_point(size=0.4) + scale_color_manual(values=c("Cycling Cancer"="#E0E509","EMT Cancer"="#0aa0bf",
                                                     "Interferon Response Cancer"="#f36e98","KRT high Cancer"="#4daa57",
                                                     "Stress Response Cancer"="#9862a2")) +
  theme(panel.background = element_rect(fill=NA,color="black"), axis.line = element_blank(),
        axis.text = element_blank(), axis.ticks = element_blank(), axis.title = element_blank(),
        legend.position = "none") + xlim(-2.75,10.75) + ylim(1,14.5)
dev.off()
svg("C:/Users/nicho/Desktop/NUS_PhD/220204 scRNAseq_slices/230410/UMAP CAF subtype Original.svg",width=6,height=6)
ggplot(cbind(Embeddings(subset(all_slices_sub$Fibroblast,Condition=="Original"),"umap"),
             subset(all_slices_sub$Fibroblast,Condition=="Original")[["sub_cell_type"]]), aes(UMAP_1,UMAP_2,color=sub_cell_type)) +
  geom_point(size=0.4) + scale_color_manual(values=c("myCAF"="#ffd800","iCAF"="#21b1ff","apCAF"="#ff218c")) +
  theme(panel.background = element_rect(fill=NA,color="black"), axis.line = element_blank(),
        axis.text = element_blank(), axis.ticks = element_blank(), axis.title = element_blank(),
        legend.position = "none") + xlim(3.5,12.5) + ylim(-8.5,0.5)
dev.off()
svg("C:/Users/nicho/Desktop/NUS_PhD/220204 scRNAseq_slices/230410/UMAP Immune subtype Original.svg",width=6,height=6)
ggplot(cbind(Embeddings(subset(all_slices_filt,final_cell_type2 %in% levels(all_slices_filt$final_cell_type2)[6:13]&Condition=="Original"),"umap"),
             subset(all_slices_filt,final_cell_type2 %in% levels(all_slices_filt$final_cell_type2)[6:13]&Condition=="Original")[["final_cell_type"]]), aes(UMAP_1,UMAP_2,color=final_cell_type)) +
  geom_point(size=0.4) + scale_color_manual(values=c("CD8 T cell"="#acff35","CD4 T cell"="#4361EE",
                                                     "Treg"="#F72585","Naive/Memory T cell"="#000000",
                                                     "IL1B high Macrophage"="#ddb892","C1Q high Macrophage"="#e50000",
                                                     "SPP1 high Macrophage"="#355070","B cell"="#8C56F8",
                                                     "Plasma cell"="#A6752C","Neutrophil"="#50D2FA",
                                                     "Dendritic cell"="#E19FD3","Monocyte"="#9A4452",
                                                     "Mast cell"="#979dac")) +
  theme(panel.background = element_rect(fill=NA,color="black"), axis.line = element_blank(),
        axis.text = element_blank(), axis.ticks = element_blank(), axis.title = element_blank(),
        legend.position = "none") + xlim(-17.75,6.25) + ylim(-17.5,6.5)
dev.off()
...
all_slices_prop_epi$Condition <- factor(all_slices_prop_epi$Condition, levels=c("Original","PhaseX"))
all_slices_prop_epi$Patient <- factor(all_slices_prop_epi$Patient, levels=c("HN377","HN385","HN390","HN396"))
all_slices_prop_epi$Cell_type <- factor(all_slices_prop_epi$Cell_type, levels=c("KRT high Cancer","EMT Cancer","Cycling Cancer","Interferon Response Cancer","Stress Response Cancer"))
all_slices_prop_caf$Condition <- factor(all_slices_prop_caf$Condition, levels=c("Original","PhaseX"))
all_slices_prop_caf$Patient <- factor(all_slices_prop_caf$Patient, levels=c("HN377","HN385","HN390","HN396"))
all_slices_prop_caf$Cell_type <- factor(all_slices_prop_caf$Cell_type, levels=c("myCAF","iCAF","apCAF"))
...
all_slices_prop_immune_sub$Condition <- factor(all_slices_prop_immune_sub$Condition, levels=c("Original","PhaseX"))
all_slices_prop_immune_sub$Patient <- factor(all_slices_prop_immune_sub$Patient, levels=c("HN377","HN385","HN390","HN396"))
all_slices_prop_immune_sub$Cell_type <- factor(all_slices_prop_immune_sub$Cell_type, levels=c("CD8 T cell","CD4 T cell","Treg","Naive/Memory T cell","IL1B high Macrophage","C1Q high Macrophage","SPP1 high Macrophage","B cell", "Plasma cell", "Neutrophil", "Dendritic cell","Monocyte", "Mast cell"))

# used to produce proportion barplots in Figures 2 to 4 and Extended Figure 3
...
ggplot(all_slices_prop_immune, aes(x=Condition, y=Proportion, fill=Cell_type)) +
  geom_bar(colour = "black", stat = "identity", show.legend = F) + ylab("Proportion (%)") + xlab("") +
  scale_fill_manual(values = c("T cell"="#00FE7F","B cell"="#8C56F8","Plasma cell"="#A6752C","Macrophage"="#ffd500","Dendritic cell"="#E19FD3","Monocyte"="#9A4452",
                               "Neutrophil"="#50D2FA","Mast cell"="#023047"), name = "") + #coord_polar("y",start=0) +
  theme(axis.text = element_text(size=10), axis.ticks = element_line(linewidth=1),
        panel.background = element_rect(fill=NA,color="black",linewidth=1),
        panel.grid = element_blank(),
        axis.title = element_blank(), strip.text.y.left = element_blank(), strip.text = element_blank(),
        strip.background = element_blank(), legend.text = element_blank(), legend.title = element_blank()) +
  facet_wrap(.~Patient, nrow=1)
ggplot(all_slices_prop_epi, aes(x=Condition, y=Proportion, fill=Cell_type)) +
  geom_bar(colour = "black", stat = "identity", show.legend = F) + ylab("Proportion (%)") + xlab("") +
  scale_fill_manual(values = c("Cycling Cancer"="#E0E509","EMT Cancer"="#0aa0bf",
                               "Interferon Response Cancer"="#f36e98","KRT high Cancer"="#4daa57",
                               "Stress Response Cancer"="#9862a2"), name = "") + #coord_polar("y",start=0) +
  theme(axis.text = element_text(size=10), axis.ticks = element_line(linewidth=1),
        panel.background = element_rect(fill=NA,color="black",linewidth=1),
        panel.grid = element_blank(),
        axis.title = element_blank(), strip.text.y.left = element_blank(), strip.text = element_blank(),
  ...
  facet_wrap(.~Patient, nrow=1)
    width=12, height=6)
ggplot(all_slices_prop_caf, aes(x=Condition, y=Proportion, fill=Cell_type)) +
  geom_bar(colour = "black", stat = "identity", show.legend = F) + ylab("Proportion (%)") + xlab("") +
  scale_fill_manual(values = c("#ffd800","#21b1ff","#ff218c"), name = "") + #coord_polar("y",start=0) +
  theme(axis.text = element_text(size=10), axis.ticks = element_line(linewidth=1),
        panel.background = element_rect(fill=NA,color="black",linewidth=1),
        panel.grid = element_blank(),
        axis.title = element_blank(), strip.text.y.left = element_blank(), strip.text = element_blank(),
  ...
  facet_wrap(.~Patient,nrow=1)
    width=12, height=9)
ggplot(all_slices_prop_immune_sub, aes(x=Condition, y=Proportion, fill=Cell_type)) +
  geom_bar(colour = "black", stat = "identity", show.legend = F) + ylab("Proportion (%)") + xlab("") +
  scale_fill_manual(values = c("CD8 T cell"="#acff35","CD4 T cell"="#4361EE",
                               "Treg"="#F72585","Naive/Memory T cell"="#000000",
                               "IL1B high Macrophage"="#ddb892","C1Q high Macrophage"="#e50000",
                               "SPP1 high Macrophage"="#355070","B cell"="#8C56F8",
                               "Plasma cell"="#A6752C","Neutrophil"="#50D2FA",
                               "Dendritic cell"="#E19FD3","Monocyte"="#9A4452",
                               "Mast cell"="#979dac"), name = "") + #coord_polar("y",start=0) +
  theme(axis.text = element_text(size=10), axis.ticks = element_line(linewidth=1),
        panel.background = element_rect(fill=NA,color="black",linewidth=1),
        panel.grid = element_blank(),
        axis.title = element_blank(), strip.text.y.left = element_blank(), strip.text = element_blank(),
